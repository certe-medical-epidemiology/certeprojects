...
#' 
#' These functions call the [Trello API](https://api.trello.com) and are internally used by [project_get_current_id()] (and its RStudio addin) and the Shiny apps [project_add()] and [project_edit()].
