...
You can [read the manual with explanation about all functions](https://certe-medical-epidemiology.github.io/certeprojects/reference), or install this particular R package using:

```r
install.packages("certeprojects", repos = "https://certe-medical-epidemiology.r-universe.dev")
```
