    ...
    observeEvent(input$create, {
      ...
      withProgress(message = "Creating...", value = 0, {
        ...
        if (input$filetype %in% c("R Markdown", "Beide")) {
          ...
          filecontent <- c(
            "---",
            paste0('title: "', input$title, '" # laat leeg voor geen voorblad'),
            'subtitle: ""',
            'subtitle2: ""',
            ...
            'logofront: "`r certestyle::rmarkdown_logo(\'front\')`" # 21x7 cm',
            'logofooter: "`r certestyle::rmarkdown_logo(\'footer\')`" # 0.7 cm hoog',
            "---",
            "",
